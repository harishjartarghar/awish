package app.awish.client.services;
...
import app.awish.client.models.download.Download;
...
//        AppConstants.notificationUtils.showNotificationProgress("Download", "Downloading File", 4, AwishApplication.getAppContext(), 0);
...
//            AppConstants.notificationUtils.DownloadDone("Download", "No Images to Download", 4, AwishApplication.getAppContext());
        }
...
//        AppConstants.notificationUtils.showNotificationProgress("Download", "File Downloaded", 4, AwishApplication.getAppContext(), 100);
