...
import app.awish.client.services.MyIntentService;
...
import app.awish.client.models.dto.PatientAttributeTypeMasterDTO;
...
public class PatientsDAO {
    ...
    public boolean updateOpemmrsId(String openmrsId, String synced, String uuid) throws DAOException {
        ...
        Intent intent = new Intent(AwishApplication.getAppContext(), MyIntentService.class);
