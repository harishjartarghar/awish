...
import app.awish.client.models.ObsImageModel.ObsJsonResponse;
import app.awish.client.models.ObsImageModel.ObsPushDTO;
import app.awish.client.models.patientImageModelRequest.PatientProfile;
...
//                            AppConstants.notificationUtils.DownloadDone("Patient Profile", "Uploaded Patient Profile", 4, AwishApplication.getAppContext());
                        }

                        @Override
                        public void onError(Throwable e) {
                            Logger.logD(TAG, "Onerror " + e.getMessage());
//                            AppConstants.notificationUtils.DownloadDone("Patient Profile", "Error Uploading Patient Profile", 4, AwishApplication.getAppContext());
                        }
                    });
        }
        sessionManager.setPullSyncFinished(true);
//        AppConstants.notificationUtils.DownloadDone("Patient Profile", "Completed Uploading Patient Profile", 4, AwishApplication.getAppContext());
        return true;
    }
        ...
        for (ObsPushDTO p : obsImageJsons) {
            ...
            obsJsonResponseObservable.subscribeOn(Schedulers.io())
                    ...
                    .subscribe(new DisposableObserver<ObsJsonResponse>() {
                        ...
                        public void onError(Throwable e) {
                            Logger.logD(TAG, "Onerror " + e.getMessage());
//                            AppConstants.notificationUtils.DownloadDone("Patient Profile", "Error Uploading Patient Profile", AwishApplication.getAppContext());
                        }
