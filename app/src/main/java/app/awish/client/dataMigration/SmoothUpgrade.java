package app.awish.client.dataMigration;
    ...
    public void exportDB() {
        try {
            ...
            if (sd.canWrite()) {
                ...
                File currentDB = new File(data + "/data/io.awish.client/databases/", "localRecords.db");
...
// added the static location details,provider,creator id in the database
    ...
    public void opendatabase() throws SQLException {
        ...
        if (new File(AppConstants.dbfilepath).exists())
            ...
            mypath = Environment.getExternalStoragePublicDirectory("InteleHealth_DB") + "Awish.db";
