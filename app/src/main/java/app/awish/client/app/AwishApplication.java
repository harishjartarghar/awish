...
public class AwishApplication extends MultiDexApplication implements Application.ActivityLifecycleCallbacks {

    private static final String TAG = AwishApplication.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        if (url == null) {
            ...
            AwishDatabaseHelper mDbHelper = new AwishDatabaseHelper(this);
