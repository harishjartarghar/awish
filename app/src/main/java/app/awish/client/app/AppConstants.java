...
import app.awish.client.syncModule.LastSyncWork;
import app.awish.client.syncModule.VisitSummaryWork;
...
import app.awish.client.syncModule.SyncWorkManager;
...
public class AppConstants {
    ...
    public static final String dbfilepath = Environment.getExternalStorageDirectory() + File.separator + "InteleHealth_DB" + File.separator + "Awish.db"; // directory: Awish_DB   ,  filename: Awish.db
    public static String CONFIG_FILE_NAME = "config.json";
    public static final String IMAGE_PATH = AwishApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES) + File.separator;
    ...
    //functions constants
    public static AwishDatabaseHelper inteleHealthDatabaseHelper = new AwishDatabaseHelper(AwishApplication.getAppContext());
    public static final String UNIQUE_WORK_NAME = "awish_workmanager";
