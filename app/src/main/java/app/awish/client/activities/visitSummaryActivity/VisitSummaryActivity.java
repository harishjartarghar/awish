package app.awish.client.activities.visitSummaryActivity;
...
import app.awish.client.R;
import app.awish.client.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import app.awish.client.activities.complaintNodeActivity.ComplaintNodeActivity;
import app.awish.client.activities.familyHistoryActivity.FamilyHistoryActivity;
import app.awish.client.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
import app.awish.client.activities.patientSurveyActivity.PatientSurveyActivity;
import app.awish.client.app.AppConstants;
import app.awish.client.app.AwishApplication;
import app.awish.client.database.dao.EncounterDAO;
import app.awish.client.database.dao.ImagesDAO;
import app.awish.client.database.dao.ObsDAO;
import app.awish.client.database.dao.PatientsDAO;
import app.awish.client.database.dao.SyncDAO;
import app.awish.client.database.dao.VisitsDAO;
import app.awish.client.knowledgeEngine.Node;
import app.awish.client.models.ClsDoctorDetails;
import app.awish.client.models.Patient;
import app.awish.client.models.dto.ObsDTO;
import app.awish.client.models.pushRequestApiCall.Visit;
import app.awish.client.services.DownloadService;
import app.awish.client.syncModule.SyncUtils;
import app.awish.client.utilities.DateAndTimeUtils;
import app.awish.client.utilities.FileUtils;
import app.awish.client.utilities.Logger;
import app.awish.client.utilities.SessionManager;
import app.awish.client.utilities.UuidDictionary;

import app.awish.client.activities.homeActivity.HomeActivity;
import app.awish.client.activities.physcialExamActivity.PhysicalExamActivity;
import app.awish.client.activities.vitalActivity.VitalsActivity;
import app.awish.client.utilities.NetworkConnection;
import app.awish.client.utilities.exception.DAOException;
...
public class VisitSummaryActivity extends AppCompatActivity {
    ...
    public static final String FILTER = "io.awish.client.activities.visit_summary_activity.REQUEST_PROCESSED";
...
//                    MaterialAlertDialogBuilder alertDialogBuilder = new MaterialAlertDialogBuilder(this,R.style.AlertDialogStyle);
                    ...
                    //alertDialog.show();
                    AwishApplication.setAlertDialogCustomTheme(this, alertDialog);
            ...
            public void onClick(View v) {
                ...
                famHistDialog.setPositiveButton(getString(R.string.generic_manual_entry), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        dialogInterface.dismiss();
                        AwishApplication.setAlertDialogCustomTheme(VisitSummaryActivity.this, alertDialog);
                    }
                });
            ...
            public void onClick(View v) {
                ...
                physicalDialog.setPositiveButton(getString(R.string.generic_manual_entry), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        AwishApplication.setAlertDialogCustomTheme(VisitSummaryActivity.this, dialog);
                        dialogInterface.dismiss();
                    }
                });
