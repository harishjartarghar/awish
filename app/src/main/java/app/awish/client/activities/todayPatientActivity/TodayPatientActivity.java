package app.awish.client.activities.todayPatientActivity;
...
import app.awish.client.database.dao.ProviderDAO;
import app.awish.client.database.dao.VisitsDAO;
import app.awish.client.models.TodayPatientModel;
