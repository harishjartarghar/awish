package app.awish.client.activities.patientDetailActivity;
...
import app.awish.client.models.dto.EncounterDTO;
import app.awish.client.models.dto.VisitDTO;
import app.awish.client.utilities.DateAndTimeUtils;
import app.awish.client.utilities.DownloadFilesUtils;
...
import app.awish.client.utilities.UrlModifiers;
...
import app.awish.client.activities.visitSummaryActivity.VisitSummaryActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newVisit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AwishDatabaseHelper mDatabaseHelper = new AwishDatabaseHelper(PatientDetailActivity.this);
