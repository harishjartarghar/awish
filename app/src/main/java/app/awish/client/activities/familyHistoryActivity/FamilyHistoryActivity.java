package app.awish.client.activities.familyHistoryActivity;
...
import app.awish.client.activities.questionNodeActivity.QuestionsAdapter;
...
import app.awish.client.utilities.pageindicator.ScrollingPagerIndicator;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(app.awish.client.utilities.StringUtils.getValue(value));
