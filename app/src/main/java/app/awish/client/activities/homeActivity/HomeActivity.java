package app.awish.client.activities.homeActivity;
...
import app.awish.client.activities.activePatientsActivity.ActivePatientActivity;
import app.awish.client.activities.identificationActivity.IdentificationActivity;
import app.awish.client.activities.loginActivity.LoginActivity;
import app.awish.client.activities.privacyNoticeActivity.PrivacyNotice_Activity;
import app.awish.client.activities.searchPatientActivity.SearchPatientActivity;
import app.awish.client.activities.settingsActivity.SettingsActivity;
import app.awish.client.activities.todayPatientActivity.TodayPatientActivity;
import app.awish.client.activities.videoLibraryActivity.VideoLibraryActivity;
import app.awish.client.app.AppConstants;
import app.awish.client.app.AwishApplication;
import app.awish.client.models.CheckAppUpdateRes;
import app.awish.client.models.DownloadMindMapRes;
import app.awish.client.networkApiCalls.ApiClient;
import app.awish.client.networkApiCalls.ApiInterface;
import app.awish.client.syncModule.SyncUtils;
import app.awish.client.utilities.ConfigUtils;
import app.awish.client.utilities.DownloadMindMaps;
import app.awish.client.utilities.Logger;
import app.awish.client.utilities.NetworkConnection;
import app.awish.client.utilities.OfflineLogin;
import app.awish.client.utilities.SessionManager;
import app.awish.client.widget.materialprogressbar.CustomProgressDialog;
            ...
            case R.id.updateProtocolsOption: {
                ...
                if (NetworkConnection.isOnline(this))
                {
                    ...
                    if (!sessionManager.getLicenseKey().isEmpty()) {
                        ...
                        AwishApplication.setAlertDialogCustomTheme(this, builderDialog);
...
//        parseLogOut();
     ...
     /*   Account[] accountList = manager.getAccountsByType("io.awish.openmrs");
