package app.awish.client.activities.setupActivity;
...
import app.awish.client.models.Location;
import app.awish.client.models.Results;
import app.awish.client.models.loginModel.LoginModel;
import app.awish.client.models.loginProviderModel.LoginProviderModel;
import app.awish.client.networkApiCalls.ApiClient;
import app.awish.client.networkApiCalls.ApiInterface;
import app.awish.client.utilities.AdminPassword;
import app.awish.client.utilities.Base64Utils;
import app.awish.client.utilities.DialogUtils;
...
import app.awish.client.utilities.StringEncryption;
...
//        manager = AccountManager.get(SetupActivity.this);
        ...
        String deviceID = "Device Id: " + AwishApplication.getAndroidId();
                        ...
                        dialog.setTitle(getString(R.string.enter_license_key))
                                ...
                                .setPositiveButton(getString(R.string.button_ok), new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (sessionManager.getLicenseKey() != null && sessionManager.getLicenseKey().equalsIgnoreCase("https://mindmaps.awish.io:4040")) {
...
//                                                responsecode = 200;
                                          /*  final Account account = new Account(USERNAME, "io.awish.openmrs");
