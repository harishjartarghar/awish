package app.awish.client.activities.settingsActivity;
...
import app.awish.client.activities.appCompatPreferenceActivity.AppCompatPreferenceActivity;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static void displayLoginDialog(Context context) {
        ...
        AwishApplication.setAlertDialogCustomTheme(activity, dialog);
    }
...
//                    b.cloudRestoreForced();
        ...
        AlertDialog dialog = textInput.show();
        AwishApplication.setAlertDialogCustomTheme(context, dialog);
    }
    ...
    public static class LanguagePreferenceFragment extends PreferenceFragment {
        ...
        public void loadLocale() {
            ...
            SharedPreferences prefs = this.getActivity().getSharedPreferences("Awish", Activity.MODE_PRIVATE);
