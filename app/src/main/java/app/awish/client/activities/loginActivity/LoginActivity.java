package app.awish.client.activities.loginActivity;
...
//                        intent.setData(Uri.parse("mailto:support@awish.io"));
//                        // intent.putExtra(Intent.EXTRA_EMAIL, "support@awish.io");
...
//                                                success = true;
                                          /*  final Account account = new Account(mEmail, "io.awish.openmrs");
