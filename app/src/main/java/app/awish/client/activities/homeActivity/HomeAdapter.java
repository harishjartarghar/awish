...
import app.awish.client.activities.activitySync.ActivitySync;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.IconViewHolder> {
    ...
    final String[] options = {AwishApplication.getAppContext().getString(R.string.new_patient),
            AwishApplication.getAppContext().getString(R.string.find_patient),
            AwishApplication.getAppContext().getString(R.string.today_visits),
            AwishApplication.getAppContext().getString(R.string.active_visits),
            AwishApplication.getAppContext().getString(R.string.video_library),
            AwishApplication.getAppContext().getString(R.string.lastsync_normal)

            // , AwishApplication.getAppContext().getString(R.string.action_sync_all)
    };
