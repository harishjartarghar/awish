package app.awish.client.activities.IntroActivity;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BASE_URL = "https://demo.awish.org/openmrs/ws/rest/v1/";
...
//        finish();
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            //Highlighting Text
            String introOne = getString(R.string.awish_a_telemedicine_platform);
            String textToHighlightOne = getString(R.string.awish_name);
                    ...
                    .subscribe(new DisposableObserver<Results<Location>>() {
                        ...
                        public void onNext(Results<Location> locationResults) {
                            if (locationResults.getResults() != null) {
                                ...
                                TestSetup("demo.awish.org", "nurse1", "Nurse123", "", location);
