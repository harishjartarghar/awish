...
import app.awish.client.models.pushRequestApiCall.Address;
import app.awish.client.models.pushRequestApiCall.Attribute;
import app.awish.client.models.pushRequestApiCall.Encounter;
import app.awish.client.models.pushRequestApiCall.EncounterProvider;
import app.awish.client.models.pushRequestApiCall.Identifier;
import app.awish.client.models.pushRequestApiCall.Name;
import app.awish.client.models.pushRequestApiCall.Ob;
import app.awish.client.models.pushRequestApiCall.Patient;
import app.awish.client.models.pushRequestApiCall.Person;
...
public class PatientsFrameJson {
    ...
    public PushRequestApiCall frameJson() {
        session = new SessionManager(AwishApplication.getAppContext());
