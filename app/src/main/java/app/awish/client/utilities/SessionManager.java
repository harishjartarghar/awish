...
public class SessionManager {
    ...
    private static final String PREF_NAME = "Awish";
    ...
    public String getBaseUrl() {
        return pref.getString(BASE_URL, "https://openmrs.awish.io");
    }
    ...
    public String getMindMapServerUrl() {
        return pref.getString(MIND_MAP_SERVER_URL, "https://mindmaps2.awish.io");
    }  //getting the sync value  and time and saving in the sharedpref
